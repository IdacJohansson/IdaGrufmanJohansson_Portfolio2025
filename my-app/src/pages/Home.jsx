        ...
        <div className="row">
          ...
          <div className="col-md-6 d-flex flex-column">
            ...
            <Card.Text>
              ...
              working with both backend and frontend, and in my work, I value
              clear structure, organization and effective communication.
            </Card.Text>
            <Card.Text>
              Given the rapid pace of IT development, I believe it’s even more
              crucial not to limit oneself. I consider myself adaptable, and
              my journey in the industry is still in its early stages. My
              background as a project manager has accustomed me to working in
              teams, an environment I’m comfortable with and enjoy.
            </Card.Text>
            <Card.Link
